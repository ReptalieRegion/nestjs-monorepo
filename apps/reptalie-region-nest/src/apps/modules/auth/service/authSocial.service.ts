...
export class AuthSocialService {
    ...
    async kakaoSignIn(dto: IEncryptedData) {
        ...
        return this.socialSignIn(decryptedData, ProviderType.Kakao);
    }
    ...
    async appleSignIn(dto: IEncryptedData) {
        ...
        return this.socialSignIn(decryptedData, ProviderType.Apple);
    }
    ...
    async googleSignIn(idToken: string) {
        ...
        try {
            ...
            return this.socialSignIn(uniqueId as string, ProviderType.Google);
        } catch (error) {
     ...
     */
    private async socialSignIn(uniqueId: string, provider: ProviderType) {
