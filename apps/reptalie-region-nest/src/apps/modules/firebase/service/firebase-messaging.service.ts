...
export const FirebaseMessagingServiceToken = 'FirebaseMessagingServiceToken';
...
export class FirebaseMessagingService {
    ...
    sendEach(messages: Message[], dryRun?: boolean | undefined): Promise<BatchResponse> {
        return this.messaging.sendEach(messages, dryRun);
    }
    sendEachForMulticast(message: MulticastMessage, dryRun?: boolean | undefined): Promise<BatchResponse> {
