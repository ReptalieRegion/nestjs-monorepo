...
export const GlobalMongooseModule = MongooseModule.forRoot(process.env.MONGODB_URI ?? '', {
    dbName: 'crawl',
});

// user 관련 모듈
export const MongooseModuleAdmin = MongooseModule.forFeature([{ name: Admin.name, schema: adminSchema }]);
