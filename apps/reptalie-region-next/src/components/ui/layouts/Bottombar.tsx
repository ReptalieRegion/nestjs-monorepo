...
const Bottombar = () => {
    ...
    return (
        <div className="bg-white flex flex-row justify-between w-full items-center border-t-[1px] rounded-3xl shadow-inner pt-20pxr">
            {menus.map(({ Icon, pageURL, name, ref }) => {
                ...
                return (
                    <div
                        ...
                        className="w-full flex justify-center ease-in-out duration-200 items-center active:scale-[0.9]"
                    >
